...
public class FacturaCompraFormController {
    ...
    public void onGuardar() {
        try {
            ...
            Dialogs.showInfo("Factura de compra guardada correctamente");
            cerrarVentana();
        } catch (Exception e) {
            log.error("Error guardando factura de compra", e);
            Dialogs.showError("Error al guardar: " + e.getMessage());
        }
    }
    ...
    public void onRegistrar() {
        ...
        Dialogs.showInfo("Factura registrada");
    }
    ...
    private boolean validarFormulario() {
        if (cbProveedor == null || cbProveedor.getValue() == null) {
            Dialogs.showError("Debe seleccionar un proveedor");
            return false;
        }
