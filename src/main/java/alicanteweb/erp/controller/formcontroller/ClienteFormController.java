...
public class ClienteFormController {
    ...
    public void onGuardar() {
        ...
        try {
            ...
            DialogUtils.showInfo(modoEdicion ?
            ...
            DialogUtils.showError(errores.toString());
        } catch (Exception e) {
            log.error("❌ Error inesperado guardando cliente", e);
            DialogUtils.showError("Error al guardar el cliente:\n" +
    ...
    public void onAbrirDirecciones() {
        try {
            ...
            if (ctrl instanceof alicanteweb.erp.controller.DireccionenvioController) {
                if (clienteActual != null && clienteActual.getId() != null) {
                    ((alicanteweb.erp.controller.DireccionenvioController) ctrl).cargarPorCliente(clienteActual.getId());
                }
            }
            ...
            DialogUtils.showError("Error al abrir direcciones: " + e.getMessage());
        }
    }
